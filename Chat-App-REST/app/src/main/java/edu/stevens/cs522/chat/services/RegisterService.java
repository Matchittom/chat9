...
public class RegisterService extends Service {
    ...
    public int onStartCommand(@NonNull Intent intent, int flags, final int startId) {
        ...
        Intent cancelIntent = new Intent(this, RegisterService.class).setAction(ACTION_CANCEL);
        ...
        notificationBuilder.addAction(new Notification.Action.Builder(icon, getString(R.string.register_cancel_button_label), cancelPendingIntent).build());
            ...
            try {
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        notificationBuilder.setContentText(getString(R.string.registered_notification_message)).setTicker(getString(R.string.registered_ticker_text));
                        ...
                        notificationBuilder.setContentText(getString(R.string.register_failed_notification_message)).setTicker(getString(R.string.register_failed_ticker_text));
                        notificationManager.notify(notificationId, notificationBuilder.build());
